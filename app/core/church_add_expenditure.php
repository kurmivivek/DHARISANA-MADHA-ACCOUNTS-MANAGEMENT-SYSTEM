			...
			<div class="panel panel-primary" >
				...
				<div class="panel-body">
					...
					<div class="col-md-offset-2 col-md-10">
						...
						$result = $db->query("SELECT *,strftime('%d-%m-%Y',date) as date,strftime('%d-%m-%Y %H:%M',timestamp) as entry_date FROM (SELECT * FROM record WHERE category='church' and type='expenditure' ORDER BY id DESC LIMIT 5) ORDER BY id ASC") or die("Query failed");
