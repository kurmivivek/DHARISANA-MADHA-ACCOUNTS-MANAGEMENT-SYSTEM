...
<?php include 'menu.php'; ?>
        <div class="col-md-12 ">
			<div class="panel panel-primary" >
				<div class="panel-heading">
					<h3><strong>Add School Expenditure</strong></h3>
				</div>
					...
					<form class="form-horizontal col-md-12 col-sm-12" role="form" id="schoolExpenditureForm" autocomplete="off">
						  ...
						  <div class="col-md-12">			
							  <div class="form-group">
								  ...
								  <button type="reset" class="btn-lg btn-primary" onclick="$('#schoolExpenditureForm').data('formValidation').resetForm();"><span class="glyphicon glyphicon-repeat"></span> Clear Form</button>
								</div>
								<div class="col-md-4">
	...
	$( "#date" ).datepicker({ dateFormat: 'dd-mm-yy',
		...
		changeYear: true,
		onSelect: function () {
		$('#schoolExpenditureForm').formValidation('updateStatus', 'date', 'NOT_VALIDATED')
...
$(document).ready(function()	{
    ...
    $('#schoolExpenditureForm').formValidation({
	    	icon: {
        ...
        .on('success.form.fv', function(e) {
            ...
            var checkRN=$.ajax({
				...
				data: {category: "school",type: "expenditure",receipt: $("#receipt").val()}, 
				cache: false,
				async: false,
					...
					if(result['valid']!=true){
	                	validRN=false;
             		    ...
             		    if (r == true) {
	             			...
	             			$("#schoolExpenditureForm button[type=submit]").removeAttr('disabled');
	             		}   	
	                }
				}
				});
            ...
            var jqxhr =$.post("ajax/add_record.php", $form.serialize() , function(result) {
                ...
                if(result['success']){
                	...
                	$('form#schoolExpenditureForm').data('formValidation').resetForm();
  		   			$('form#schoolExpenditureForm')[0].reset();
  		   			getJoinDate();
  		   		}
               	else
                swal({  title: "Error!",   
    ...
    $("form#schoolExpenditureForm").keydown(function(event){//prevent form submit on enter 
	    if( (event.keyCode == 13)  ) {
