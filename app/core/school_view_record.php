				...
				<div class="panel-body">
					...
					<div class="col-md-offset-1 col-md-10">
						...
						<tr class="success">
							...
							?></strong></td>
							<td colspan="5" style="text-align:center"><strong><?php echo $monthName;?>'s School Bank balance ₹ : <?php echo formatInIndianStyle(number_format((float)$income-(float)$expenditure, 2, '.', ''));?></strong></td>
						</tr>
						<tr class="info">		
